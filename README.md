...
Modules name ending with "L" stands for 'lite edition' and means that is optimized to work monophonic instead of regular SickoCV polyphonic modules, just to save CPU on Metamodule.
