...
struct MultiSwitcherLWidget : ModuleWidget {
	MultiSwitcherLWidget(MultiSwitcherL* module) {
		setModule(module);
		setPanel(createPanel(asset::plugin(pluginInstance, "res/MultiSwitcherL.svg")));
		...
		*/
		...
		addParam(createParamCentered<CKSS>(mm2px(Vec(xLeft, yCvSw)), module, MultiSwitcherL::MODE_SWITCH));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(xLeft, yCvSwIn)), module, MultiSwitcherL::TRG_CV_INPUT));
		addParam(createParamCentered<CKSSThree>(mm2px(Vec(xDir, yDir)), module, MultiSwitcherL::DIR_SWITCH));

		addParam(createParamCentered<SickoTrimpot>(mm2px(Vec(xLeft, yXfd)), module, MultiSwitcherL::XFD_PARAM));

		addParam(createParamCentered<SickoTrimpot>(mm2px(Vec(xLeft, yRstKn)), module, MultiSwitcherL::RST_PARAM));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(xLeft, yRstIn)), module, MultiSwitcherL::RST_INPUT));

		addParam(createParamCentered<SickoSmallKnob>(mm2px(Vec(xIns, yIns)), module, MultiSwitcherL::INS_PARAM));

		for (int i = 0; i < 8; i++) {
			addInput(createInputCentered<SickoInPort>(mm2px(Vec(xInL, ys+(i*yShift))), module, MultiSwitcherL::IN_LEFT_INPUT+i));
			addInput(createInputCentered<SickoInPort>(mm2px(Vec(xInR, ys+(i*yShift))), module, MultiSwitcherL::IN_RIGHT_INPUT+i));
			addChild(createLightCentered<SmallLight<GreenLight>>(mm2px(Vec(xLight, ys+(i*yShift)-2.5)), module, MultiSwitcherL::IN_LIGHT+i));
		}

		addOutput(createOutputCentered<SickoOutPort>(mm2px(Vec(xInL, yOut)), module, MultiSwitcherL::OUT_LEFT_OUTPUT));
		addOutput(createOutputCentered<SickoOutPort>(mm2px(Vec(xInR, yOut)), module, MultiSwitcherL::OUT_RIGHT_OUTPUT));

	}

	void appendContextMenu(Menu* menu) override {
		MultiSwitcherL* module = dynamic_cast<MultiSwitcherL*>(this->module);
...
Model* modelMultiSwitcherL = createModel<MultiSwitcherL, MultiSwitcherLWidget>("MultiSwitcherL");