...
struct TogglerMMWidget : ModuleWidget {
	TogglerMMWidget(TogglerMM* module) {
		setModule(module);
		setPanel(createPanel(asset::plugin(pluginInstance, "res/TogglerMM.svg")));
		...
		addParam(createParamCentered<CKSS>(mm2px(Vec(21.458, 15.75)), module, TogglerMM::MODE_SWITCH));

		addInput(createInputCentered<SickoInPort>(mm2px(Vec(12.5, 38.5)), module, TogglerMM::TRIG_INPUT));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(33, 38.5)), module, TogglerMM::RST_INPUT));

		addParam(createParamCentered<SickoKnob>(mm2px(Vec(8.48, 60)), module, TogglerMM::ATTACK_PARAM));
		addParam(createParamCentered<SickoTrimpot>(mm2px(Vec(8.48, 71.5)), module, TogglerMM::ATTACKATNV_PARAM));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(8.48, 80.5)), module, TogglerMM::ATTACK_INPUT));

		addParam(createParamCentered<SickoKnob>(mm2px(Vec(22.8, 60)), module, TogglerMM::SUSTAIN_PARAM));
		addParam(createParamCentered<SickoTrimpot>(mm2px(Vec(22.8, 71.5)), module, TogglerMM::SUSTAINATNV_PARAM));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(22.8, 80.5)), module, TogglerMM::SUSTAIN_INPUT));

		addParam(createParamCentered<SickoKnob>(mm2px(Vec(37.32, 60)), module, TogglerMM::RELEASE_PARAM));
		addParam(createParamCentered<SickoTrimpot>(mm2px(Vec(37.32, 71.5)), module, TogglerMM::RELEASEATNV_PARAM));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(37.32, 80.5)), module, TogglerMM::RELEASE_INPUT));

		addInput(createInputCentered<SickoInPort>(mm2px(Vec(7, 108.8)), module, TogglerMM::IN_INPUT));
		addInput(createInputCentered<SickoInPort>(mm2px(Vec(16.5, 108.8)), module, TogglerMM::IN_INPUT+1));

		addOutput(createOutputCentered<SickoOutPort>(mm2px(Vec(29, 103.2)), module, TogglerMM::OUT_OUTPUT));
		addOutput(createOutputCentered<SickoOutPort>(mm2px(Vec(39.2, 103.2)), module, TogglerMM::OUT_OUTPUT+1));
		addOutput(createOutputCentered<SickoOutPort>(mm2px(Vec(34, 116.5)), module, TogglerMM::GATE_OUTPUT));

		addChild(createLightCentered<MediumLight<GreenLight>>(mm2px(Vec(41.2, 118.7)), module, TogglerMM::OUT_LIGHT));
	}

	void appendContextMenu(Menu* menu) override {
		TogglerMM* module = dynamic_cast<TogglerMM*>(this->module);
...
Model* modelTogglerMM = createModel<TogglerMM, TogglerMMWidget>("TogglerMM");